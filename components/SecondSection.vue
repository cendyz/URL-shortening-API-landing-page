<template>
	<section class="px-[2rem] py-[10rem] bg-primary-violet text-center relative">
		<h2 class="text-[2.7rem] font-w700 mb-[3rem] text-neutral-50 z-10 relative lg:text-[3.5rem]">Boost your links today</h2>
		<a
			href="#"
